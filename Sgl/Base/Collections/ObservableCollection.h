...
namespace Sgl
{
	...
	{
	public:
		using NofityEventHandler = EventHandler<ObservableCollection<T>, NotifyEventArgs>;
	...
	public:
		...
		ObservableCollection(size_t count):
			_items(count)
		{}

		ObservableCollection(size_t count, const T& value):
			_items(count, value)
		{}
		...
		ObservableCollection(TRange&& range):
		...
		ObservableCollection& operator=(std::initializer_list<T> init)
		{
			_items = init;
			OnChanged(NotifyEventArgs
			{
